...
sap.ui.core.Control.extend("sap.m.SplitApp", { metadata : {
	...
	publicMethods : [
		// methods
		"to", "backToPage", "toMaster", "toDetail", "backMaster", "backDetail", "showMaster", "hideMaster", "getCurrentMasterPage", "getCurrentDetailPage", "backToTopMaster", "backToTopDetail"
	],
...
sap.m.SplitApp.prototype.setMode = function(sMode) {
	...
	if(jQuery.device.is.tablet && this.getDomRef()){
