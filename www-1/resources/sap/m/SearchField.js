...
sap.m.SearchField.prototype.ontouchstart=function(e){e.originalEvent._sapui_handledByControl=true;if(!this.getEnabled())return;var s=e.srcElement;if(s.id==this.getId()+"-reset"){var v="";this._inputElement.value=v;this.setProperty("value",v,true);this.fireLiveChange({newValue:v});this.fireSearch({query:v});e.preventDefault();e.stopPropagation()}};
