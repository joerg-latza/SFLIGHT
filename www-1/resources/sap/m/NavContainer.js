	...
	to: function(oFromPage, oToPage, fCallback /*, oTransitionParameters is unused */) {
		...
		window.setTimeout(function(){ // iPhone seems to need a zero timeout here, otherwise the to page is black (and may suddenly become visible when the DOM is touched)
			...
			window.setTimeout(function(){
				...
				oFromPage.$().one("webkitTransitionEnd transitionend", fAfterTransition);
				oToPage.$().one("webkitTransitionEnd transitionend", fAfterTransition);
	...
	to: function(oFromPage, oToPage, fCallback /*, oTransitionParameters is unused */) {
		...
		window.setTimeout(function(){ // iPhone seems to need a zero timeout here, otherwise the to page is black (and may suddenly become visible when the DOM is touched)
			...
			window.setTimeout(function(){
				...
				oFromPage.$().one("webkitAnimationEnd animationend", fAfterTransition);
				oToPage.$().one("webkitAnimationEnd animationend", fAfterTransition);
