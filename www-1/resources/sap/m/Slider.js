...
sap.m.Slider.prototype.onAfterRendering = function() {
	...
	this._$Sld = this._$SldCont.children(".sapMSli");

	// handle jQuery reference
	this._$Handle = this._$Sld.children(".sapMSliHandle");

	// native input type range jQuery reference
	this._$Input = this._$SldCont.children("input[type=range].sapMSliInput");

	//	after all calculations, make visible the control
	this._$SldCont.addClass("sapMSliVisible");
};
...
sap.m.Slider.prototype._ontouchstart = function(oEvent) {
	...
	// add active state
	this._$Sld.addClass("sapMSliPressed");

	if ($Target.is(this._$Handle) || $Target.parent().is(this._$Handle)) {	// if the target is the slider thumb
...
sap.m.Slider.prototype._ontouchend = function() {
	...
	// remove active state
	this._$Sld.removeClass("sapMSliPressed");
...
sap.m.Slider.prototype._calcMeasures = function() {
	...
	// thumb width
	this._iHandleWidth = this._$Handle.width();
};
...
sap.m.Slider.prototype._setValue = function(fNewValue) {
	...
	if (this._$SldCont instanceof jQuery) {	//	after re-rendering
		...
		if (this.getProgress()) {
			...
			this._$Sld.css("-webkit-background-size", fPerVal + "% 100%, cover");
		}

		// update the thumb position
		this._$Handle.css("left", fPerVal + "%");
	}
