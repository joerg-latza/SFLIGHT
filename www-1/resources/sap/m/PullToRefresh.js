...
sap.ui.core.Control.extend("sap.m.PullToRefresh", { metadata : {
	...
	properties : {
		...
		"showIcon" : {type : "boolean", group : "Appearance", defaultValue : true},
 ...
 * Set to false if you do not want to display an icon/logo.
 *
...
/**
 * Hides the control and resets it to the normal state
 *
...
sap.m.PullToRefresh.prototype.init = function(){
	...
	this._oBusyIndicator = new sap.m.BusyIndicator({size: "2.5em", design: "light"});
...
sap.m.PullToRefresh.prototype.setState = function(iState){
	...
	switch(iState){
		case 0:
			...
			$text.html(this.oRb.getText("PULL2REFRESH_PULLDOWN"));
			this._iState = iState;
			break;
		case 1:
