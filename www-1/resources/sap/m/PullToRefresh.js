...
sap.m.PullToRefresh.prototype.init=function(){this._iState=0;this.oRb=sap.ui.getCore().getLibraryResourceBundle("sap.m")};
...
sap.m.PullToRefresh.prototype.onAfterRendering=function(){if(this._oScroller){this._oScroller.refresh()}};
sap.m.PullToRefresh.prototype.exit=function(){if(this._oScroller){this._oScroller.setPullDown(null)}this._oScroller=null};
sap.m.PullToRefresh.prototype.doScrollMove=function(){if(!this._oScroller){return}var _=this._oScroller._scroller;if(_.y>1&&this._iState<1){this.setState(1);_.minScrollY=0}else if(_.y<1&&this._iState==1){this.setState(0);_.minScrollY=-this.getDomRef().offsetHeight}};
