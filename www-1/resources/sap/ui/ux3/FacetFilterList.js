 ...
 *
 * @class
 * Internal sub-control of the FacetFilter. The control is not intended to be used stand alone. For this purpose, the FacetFilter control can be used.
 ...
 * @constructor   
 * @public
 * @experimental Since version 1.5. 
