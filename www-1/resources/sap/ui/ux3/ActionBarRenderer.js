...
;
sap.ui.ux3.ActionBarRenderer._renderSocialAction=function(r,c,a){if(a.isMenu&&a.isMenu(c)){r.write("<a role=\"button\" aria-disabled=\"false\" aria-haspopup=\"true\"")}else{r.write("<a  role=\"button\" aria-disabled=\"false\" aria-haspopup=\"false\"")}r.writeAttribute("tabindex","0");r.writeElementData(a);r.addClass(a.cssClass);if(a.fnCalculateState){r.addClass(a.fnCalculateState(c))}r.addClass("sapUiUx3ActionBarAction");r.writeClasses();if(a.getTooltip()){r.writeAttributeEscaped("title",a.getTooltip())}if(a.text){r.writeAttributeEscaped("text",c.getLocalizedText(a.getText()))}r.write("></a>")};
