...
sap.ui.ux3.Overlay.prototype._initDom = function(fFocusFirst, fFocusLast) {
	...
	if (oShell) {
		...
		oShell.syncWithCanvasSize(this.getId(), true, fFocusFirst, fFocusLast);
		jQuery.sap.byId(this.getId() + "-firstFocusDummyPaneFw").attr("tabindex", "0").focusin(jQuery.proxy(oShell.focusFirstTool,oShell));
...
sap.ui.ux3.Overlay.prototype.onAfterRendering = function() {
    ...
    if(oPopupState === sap.ui.core.OpenState.OPEN || oPopupState === sap.ui.core.OpenState.OPENING){
          this._initDom(jQuery.proxy(this._setFocusFirst, this), jQuery.proxy(this._setFocusLast, this));
    }
};
