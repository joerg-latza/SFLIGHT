...
(function() {
	...
	sap.ui.ux3.ThingInspector.prototype.onAfterRendering = function() {
		...
		// if property will be public there will be no automatism anymore!
		if(!oShell || oShell.getHeaderType() === "BrandOnly") {
			this._setShowOverlay(false);
		}
	};
	...
	//Currently not a public property 'showOverlay' but maybe later
	sap.ui.ux3.ThingInspector.prototype._setShowOverlay = function(bShowOverlay) {
		this._bShowOverlay = bShowOverlay;
		if( bShowOverlay ) {
	...
	//Currently not a public property 'showOverlay' but maybe later
	sap.ui.ux3.ThingInspector.prototype._getShowOverlay = function(bShowOverlay) {
		return this._bShowOverlay;
	};
