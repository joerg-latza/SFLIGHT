...
(function() {
	...
	sap.ui.commons.form.ResponsiveLayout.prototype.init = function(){
		...
		this._defaultLayoutData = new sap.ui.commons.layout.ResponsiveFlowLayoutData({margin: false});
	...
	sap.ui.commons.form.ResponsiveLayout.prototype.onsapup = function(oEvent){
		this.onsapleft(oEvent);
	};

	sap.ui.commons.form.ResponsiveLayout.prototype.onsapdown = function(oEvent){
	...
	var _createResponsiveFlowLayout = function( oLayout, oContainer, oElement, bElementContent ) {
		...
		if ((oElement && !bElementContent) || (!oElement && !oContainer.getTitle() && !oContainer.getExpandable())) {
			...
			oRFLayout.setLayoutData(new sap.ui.commons.layout.ResponsiveFlowLayoutData({margin: false}));
		}
	...
	var _changeGetLayoutDataOfResponsiveFlowLayout = function( oRFLayout, bOriginal ) {
		...
		if (bOriginal) {
			...
			oRFLayout.getLayoutData = function(){
				...
				var oLD;
				if (oElement) {
					oLD = oLayout.getLayoutDataForElement(oElement, "sap.ui.commons.layout.ResponsiveFlowLayoutData");
				}else if (oContainer) {
					oLD = oLayout.getLayoutDataForElement(oContainer, "sap.ui.commons.layout.ResponsiveFlowLayoutData");
				}
