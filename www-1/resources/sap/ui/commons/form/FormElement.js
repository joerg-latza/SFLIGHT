 ...
 */
sap.ui.core.Element.extend("sap.ui.commons.form.FormElement", { metadata : {
 ...
 * @public
 * @name sap.ui.commons.form.FormElement#getLabel
 * @function
 */
 ...
 * @public
 * @name sap.ui.commons.form.FormElement#setLabel
 * @function
 */
 ...
 * @return {sap.ui.commons.form.FormElement} <code>this</code> to allow method chaining
 * @public
 * @name sap.ui.commons.form.FormElement#destroyLabel
 * @function
 */
 ...
 * @public
 * @name sap.ui.commons.form.FormElement#getFields
 * @function
 */
 ...
 * @return {sap.ui.commons.form.FormElement} <code>this</code> to allow method chaining
 * @public
 * @name sap.ui.commons.form.FormElement#insertField
 * @function
 */
 ...
 * @return {sap.ui.commons.form.FormElement} <code>this</code> to allow method chaining
 * @public
 * @name sap.ui.commons.form.FormElement#addField
 * @function
 */
 ...
 * @public
 * @name sap.ui.commons.form.FormElement#removeField
 * @function
 */
 ...
 * @public
 * @name sap.ui.commons.form.FormElement#removeAllFields
 * @function
 */
 ...
 * @public
 * @name sap.ui.commons.form.FormElement#indexOfField
 * @function
 */
 ...
 * @return {sap.ui.commons.form.FormElement} <code>this</code> to allow method chaining
 * @public
 * @name sap.ui.commons.form.FormElement#destroyFields
 * @function
 */
 ...
 *
 * @name sap.ui.commons.form.FormElement.prototype.getLabelControl
 * @function
...
sap.ui.core.EnabledPropagator.apply(sap.ui.commons.form.FormElement.prototype, [true]);

(function() {

	sap.ui.commons.form.FormElement.prototype.init = function(){

		this._oFieldDelegate = {oElement: this, onAfterRendering: _fieldOnAfterRendering};

	};

	sap.ui.commons.form.FormElement.prototype.exit = function(){
	...
	sap.ui.commons.form.FormElement.prototype.setLabel = function(vAny) {

		// if only a string is provided just create an internal label control.
		var that = this;
		if (!this._oLabel) {
		...
		if (typeof oLabel === "string") {
			if (!this._oLabel) {
				this._oLabel = new sap.ui.commons.Label({text: oLabel}).setParent(this);
	...
	sap.ui.commons.form.FormElement.prototype.getLabelControl = function() {
	...
	sap.ui.commons.form.FormElement.prototype.addField = function(oField) {
	...
	sap.ui.commons.form.FormElement.prototype.insertField = function(oField, iIndex) {
	...
	sap.ui.commons.form.FormElement.prototype.removeField = function(oField) {
	...
	sap.ui.commons.form.FormElement.prototype.removeAllFields = function() {
	...
	sap.ui.commons.form.FormElement.prototype.destroyFields = function() {
	...
	sap.ui.commons.form.FormElement.prototype.updateFields = function() {
	 ...
	 */
	sap.ui.commons.form.FormElement.prototype.enhanceAccessibilityState = function(oElement, mAriaProps) {
	 ...
	 */
	sap.ui.commons.form.FormElement.prototype.onLayoutDataChange = function(oEvent){
