...
sap.ui.commons.Slider.prototype.onAfterRendering = function () {
	...
	if (this.bTextLabels && this.getLabels().length != this.getTotalUnits()) {
		jQuery.sap.log.warning('label count and total units should be the same','sap.ui.commons.Slider');
	}
