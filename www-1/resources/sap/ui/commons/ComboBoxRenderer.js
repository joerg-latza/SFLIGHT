...
sap.ui.commons.ComboBoxRenderer.renderComboARIAInfo=function(r,c){var p={role:"combobox",owns:c.getId()+"-input "+c._getListBox().getId()};if(!c.getEnabled()){p["disabled"]=true}r.writeAccessibilityState(null,p)};
