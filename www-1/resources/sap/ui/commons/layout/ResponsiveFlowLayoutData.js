 ...
 * <li>{@link #getMargin margin} : boolean (default: true)</li></ul>
 * </li>
 * <li>Aggregations
 * <ul></ul>
 * </li>
...
sap.ui.commons.layout.ResponsiveFlowLayoutData.MARGIN = true;

sap.ui.commons.layout.ResponsiveFlowLayoutData.prototype.setWeight = function(iWeight) {
	if (iWeight > 1) {
		...
		this.setProperty("weight", sap.ui.commons.layout.ResponsiveFlowLayoutData.WEIGHT);
	}
