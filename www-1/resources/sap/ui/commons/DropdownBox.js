...
sap.ui.commons.DropdownBox.prototype._handleItemsChanged = function(oEvent){
...
sap.ui.commons.DropdownBox.prototype.onkeydown = function(oEvent) {
	...
	if((jQuery.browser.msie && (oEvent.which == jQuery.sap.KeyCodes.DELETE || oEvent.which == jQuery.sap.KeyCodes.BACKSPACE)) ||
	   (jQuery.browser.webkit && (oEvent.which == jQuery.sap.KeyCodes.DELETE || oEvent.which == jQuery.sap.KeyCodes.BACKSPACE))) {
...
sap.ui.commons.DropdownBox.prototype.onkeypress = function(oEvent) {
	...
	if(( sap.ui.commons.ComboBox._isHotKey(oEvent)
		    || ( jQuery.browser.mozilla && iKeyCode === oKC.HOME ) || // IE & webkit fires no keypress on HOME, but "$" has the same keyCode
...
sap.ui.commons.DropdownBox.prototype.setValue = function(sValue) {
	...
	if(bValueOK) {
		...
		sap.ui.commons.ComboBox.prototype.setValue.call(this, sFirstEnabledValue);
	}else{
