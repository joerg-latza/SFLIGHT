...
sap.ui.commons.CheckBox.prototype.onclick=function(e){if(jQuery.browser.msie&&(!this.getEnabled())){jQuery.sap.byId(this.getId()).attr("tabindex",0).addClass("sapUiCbFoc")}this.userToggle(e)};
sap.ui.commons.CheckBox.prototype.onfocusout=function(e){if(jQuery.browser.msie&&(!this.getEnabled())){jQuery.sap.byId(this.getId()).attr("tabindex",-1).removeClass("sapUiCbFoc")}};
...
sap.ui.commons.CheckBox.prototype.toggle=function(){this.setChecked(!this.getChecked())};
