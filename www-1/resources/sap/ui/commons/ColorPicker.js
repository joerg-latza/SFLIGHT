...
sap.ui.commons.ColorPicker.prototype.init = function(){
	...
	//	1.Horizontal Layout
	this.oHLayout1 = new sap.ui.commons.layout.HorizontalLayout({
		content: [this.oRedLabel, this.oRedField, this.oHueLabel, this.oHueField]
	});

	//	2.Horizontal Layout
	this.oHLayout2 = new sap.ui.commons.layout.HorizontalLayout({
		content: [this.oGreenLabel, this.oGreenField, this.oSatLabel, this.oSatField]
	});

	//	3.Horizontal Layout
	this.oHLayout3 = new sap.ui.commons.layout.HorizontalLayout({
		content: [this.oBlueLabel, this.oBlueField, this.oValLabel, this.oValField]
	});

	//	4.Horizontal Layout
	this.oHLayout4 = new sap.ui.commons.layout.HorizontalLayout({
		content: [this.oHexLabel, this.oHexField, this.oHtmlOldCol, this.oHtmlNewCol]
	});

	//	Vertical Layout containing the four horizontal layouts
	...
	this.oMatrix.createRow(this.oHtmlBox, this.oVLayout);

	//	create second Row containing slider
	this.oRow2 = new sap.ui.commons.layout.MatrixLayoutRow();
	this.oCell = new sap.ui.commons.layout.MatrixLayoutCell({ colSpan : 2 });
...
sap.ui.commons.ColorPicker.prototype.setColorString = function(iColorString) {
	...
	this.fireLiveChange({r:this.Color.r, g:this.Color.g, b:this.Color.b, h:this.Color.h, s:this.Color.s, v:this.Color.v, hex:this.Color.hex});
	this.fireChange({r:this.Color.r, g:this.Color.g, b:this.Color.b, h:this.Color.h, s:this.Color.s, v:this.Color.v, hex:this.Color.hex});
	this.setProperty('colorString', this.rgbString, true); // No re-rendering!
};
...
/**
 * Create RGB-String from the current RGB-Values
 */
sap.ui.commons.ColorPicker.prototype._createRGBString = function( ){

	this.rgbString = "rgb(" + this.Color.r.toString() + "," + this.Color.g.toString() + "," + this.Color.b.toString() + ")";
}
...
sap.ui.commons.ColorPicker.prototype._updateGradientBoxBackground = function(hue){
	...
	//	set backgroundColor
	this.$cpBox.css('background-color',hexCol);
};
...
sap.ui.commons.ColorPicker.prototype._updateSelColorBackground = function(){
	...
	//	set the new color
	jQuery.sap.byId(this.getId()+'-ncBox').css('background-color',this.Color.hex);
};
...
sap.ui.commons.ColorPicker.prototype.onAfterRendering = function (){
	...
	jQuery.sap.byId(this.getId()+'-ncBox').css('background-color',this.Color.hex);
	jQuery.sap.byId(this.getId()+'-ocBox').css('background-color',this.Color.hex);
