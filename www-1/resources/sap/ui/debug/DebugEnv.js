...
jQuery.sap.require("sap.ui.debug.ControlTree");
jQuery.sap.require("sap.ui.debug.Highlighter");
jQuery.sap.require("sap.ui.debug.LogViewer");
jQuery.sap.require("sap.ui.debug.PropertyList");
 ...
 * @public
 */
sap.ui.debug.DebugEnv.prototype.startPlugin = function(oCore, bOnInit) {
 ...
 * @public
 */
sap.ui.debug.DebugEnv.prototype.stopPlugin = function() {
 ...
 * @private
 */
sap.ui.debug.DebugEnv.prototype.init = function(bOnInit) {
	...
	*/
	...
	this.oControlTree = new sap.ui.debug.ControlTree(this.oCore, this.oWindow, oControlTreeRoot, this.bRunsEmbedded);
	this.oPropertyList = new sap.ui.debug.PropertyList(this.oCore, this.oWindow, oPropertyWindowRoot);
	this.oControlTree.attachEvent(sap.ui.debug.ControlTree.M_EVENTS.SELECT, this.oPropertyList.update,
			this.oPropertyList);
	if ( !bOnInit ) {
 ...
 * @private
 */
sap.ui.debug.DebugEnv.prototype.initLogger = function(oLogger, bOnInit) {
	this.oLogger = oLogger;
	if ( !this.bRunsEmbedded ) {
		// attach test suite log viewer to our jQuery.sap.log
		this.oTraceWindow = top.frames["sap-ui-TraceWindow"];
		this.oTraceViewer = this.oTraceWindow.oLogViewer = new sap.ui.debug.LogViewer(this.oTraceWindow, 'sap-ui-TraceWindowRoot');
		...
		this.oTraceViewer = new sap.ui.debug.LogViewer(this.oTraceWindow, 'sap-ui-TraceWindowRoot');
	}
...
sap.ui.debug.DebugEnv.prototype.enableLogViewer = function() {
 ...
 */
sap.ui.debug.DebugEnv.prototype.isRunningEmbedded = function() {
 ...
 */
sap.ui.debug.DebugEnv.prototype.isControlTreeShown = function() {
 ...
 */
sap.ui.debug.DebugEnv.prototype.showControlTree = function() {
 ...
 */
sap.ui.debug.DebugEnv.prototype.hideControlTree = function() {
 ...
 */
sap.ui.debug.DebugEnv.prototype.isTraceWindowShown = function() {
 ...
 */
sap.ui.debug.DebugEnv.prototype.showTraceWindow = function() {
 ...
 */
sap.ui.debug.DebugEnv.prototype.hideTraceWindow = function() {
	var oLogViewer = this.oTraceWindow && this.oTraceWindow.document.getElementById('sap-ui-TraceWindowRoot');
	if ( oLogViewer ) {
 ...
 */
sap.ui.debug.DebugEnv.prototype.isPropertyListShown = function() {
 ...
 * Will be called to show the PropertyList
 */
sap.ui.debug.DebugEnv.prototype.showPropertyList = function() {
 ...
 */
sap.ui.debug.DebugEnv.prototype.hidePropertyList = function() {
 ...
 */
(function(){
	var oThis = new sap.ui.debug.DebugEnv();
	sap.ui.getCore().registerPlugin(oThis);
	sap.ui.debug.DebugEnv.getInstance = jQuery.sap.getter(new sap.ui.base.Interface(oThis, ["isRunningEmbedded", "isControlTreeShown", "showControlTree", "hideControlTree", "isTraceWindowShown", "showTraceWindow", "hideTraceWindow", "isPropertyListShown", "showPropertyList", "hidePropertyList"]));
}());