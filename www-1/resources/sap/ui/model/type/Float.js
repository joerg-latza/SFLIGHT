...
sap.ui.model.type.Float.prototype.setFormatOptions=function(f){this.oFormatOptions=f;this.oFormat=sap.ui.core.format.NumberFormat.getFloatInstance(this.oFormatOptions)};
